...
function Electronic() {
  ...
  const Eproducts = products.filter((item) => item.category === "electronics");
  ...
  return (
    ...
    className="container text-center bg_page ">
    
      <div className="row ">
        <motion.h1  animate={{ fontSize:50,color:'black'}}
    transition={{ delay: 0.7, }} className="all-products-title ">Electronic</motion.h1>
